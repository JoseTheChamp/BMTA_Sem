...
class Hero(
    ...
    constructor(
        name: String, description: String, health: Double, attack: Double, armor: Double,
        strength: Double, wisdom: Double, inteligence: Double,
        charisma: Double, constitution: Double, dexterity: Double
    ) : this(name, description, health, attack, armor) {
